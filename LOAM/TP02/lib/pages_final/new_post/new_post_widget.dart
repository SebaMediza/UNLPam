...
class _NewPostWidgetState extends State<NewPostWidget> {
  ...
  void initState() {
    ...
    _model.cuerpoController ??= TextEditingController();
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 8.0, 0.0),
                        child: TextFormField(
                          controller: _model.cuerpoController,
                          ...
                          validator: _model.cuerpoControllerValidator
                              .asValidator(context),
                        ),
                      ),
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (!(_model.uploadedLocalFile1 != null &&
                          (_model.uploadedLocalFile1.bytes?.isNotEmpty ??
                              false))) {
                        await FwittsRecord.collection
                            .doc()
                            .set(createFwittsRecordData(
                              postPhoto: 'NULL',
                              postDescription: _model.cuerpoController.text,
                              postUser: FFAppState().uid,
                              postTitle: _model.tituloController.text,
                              timePosted: dateTimeFromSecondsSinceEpoch(
                                  getCurrentTimestamp.secondsSinceEpoch),
                              numComments: functions.randomInteger(),
                              numVotes: functions.randomDouble(),
                              likes: functions.randomInteger(),
                            ));
                        return;
                      }
                      {
